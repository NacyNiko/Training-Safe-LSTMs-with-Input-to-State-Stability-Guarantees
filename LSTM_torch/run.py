...
parser.add_argument('--hidden_size', default=50, help='hidden size of LSTM', type=int)
...
parser.add_argument('--len_sequence', default=20, help='length of input sequence to LSTM', type=int)
