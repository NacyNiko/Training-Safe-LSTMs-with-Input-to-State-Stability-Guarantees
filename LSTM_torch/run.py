...
parser.add_argument('--reg_methode', default='log_barrier_BLS', choices=['relu', 'log_barrier_BLS', 'vanilla'], help='regularization methode')
...
if __name__ == '__main__':
    ...
    if grid_Search:
        ...
        hidden_values = [160, 200]
        len_sequence_values = [30, 40]
