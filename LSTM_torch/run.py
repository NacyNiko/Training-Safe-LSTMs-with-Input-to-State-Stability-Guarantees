...
parser.add_argument('--epochs', default=20, help='maximum train epochs', type=int)
...
parser.add_argument(
    '--curriculum_learning', default='balance', choices=[None, '2part', '2zero', 'balance', 'exp', 'PID', 'IncrePID'], help='apply curriculum_learning or not')
