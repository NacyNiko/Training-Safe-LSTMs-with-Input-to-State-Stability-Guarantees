...
parser.add_argument('--hidden_size', default=250, help='hidden size of LSTM', type=int)
...
parser.add_argument(
    '--curriculum_learning', default='PID', choices=[None, '2part', '2zero', 'balance', 'exp', 'PID', 'IncrePID'], help='apply curriculum_learning or not')
...
parser.add_argument('--gamma', default=torch.tensor([10., 10.]), help='value of gamma', type=torch.Tensor)
