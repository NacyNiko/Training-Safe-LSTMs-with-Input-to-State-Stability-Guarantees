...
parser.add_argument('--gamma', default=torch.tensor([100., 100.]), help='value of gamma', type=torch.Tensor)
parser.add_argument('--threshold', default=torch.tensor([0., 0.]), help='value of threshold', type=torch.Tensor)
